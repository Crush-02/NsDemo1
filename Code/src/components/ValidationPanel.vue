  ...
  <transition name="slide">
    <div v-if="visible" class="validation-panel">
      ...
      <div class="panel-footer">
        <el-button
          size="small"
          :loading="schedulerProgress.isRunning"
          @click="refreshValidation"
        >
          {{ schedulerProgress.isRunning ? '校验中...' : '重新校验' }}
        </el-button>
        <el-button
          v-if="schedulerProgress.isRunning"
          size="small"
          type="danger"
          text
...
import { state, getAllCellErrors, startValidation, isValidationRunning, cancelValidation, schedulerProgress } from '../engine/validationStore'
...
function refreshValidation() {
  if (schedulerProgress.isRunning) return
  startValidation()
}
</script>
